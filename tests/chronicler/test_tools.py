...
from matrix_llmagent.chronicler.tools import ChapterAppendExecutor, ChapterRenderExecutor
...
async def test_chapter_render_executor_multiple_chapters(temp_config_file):
    ...
    from matrix_llmagent.chronicler.chapters import _close_chapter
