...
from matrix_llmagent.rooms import ProactiveDebouncer
...
class TestIRCMonitor:
    ...
    async def test_command_debouncing_end_to_end(self, shared_agent_with_db):
        ...
        with (
            patch("matrix_llmagent.rooms.irc.monitor.time", spec=True) as mock_time_module,
    ...
    async def test_automatic_artifact_creation_for_long_responses(self, temp_config_file):
        ...
        with patch("matrix_llmagent.main.AgenticLLMActor") as mock_agent_class:
            ...
            with patch(
                "matrix_llmagent.agentic_actor.tools.ShareArtifactExecutor"
